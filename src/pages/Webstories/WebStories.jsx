      ...
      <div className="container mx-auto px-4">
        <div className="bg-white shadow-2xl rounded-2xl overflow-hidden">
           ...
           <section className="p-8">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">Search for Web Stories Content</h2>
          ...
          <section
            ...
            style={{
              backgroundImage:
                "url('https://media.istockphoto.com/id/1256603037/photo/ai-concept-contents-concept-social-networking-service-streaming-video-communication-network.webp?a=1&b=1&s=612x612&w=0&k=20&c=0etstq-6sgiqV5Bn9jVDfUvqe8WiFvq6cF0-Ebsgi40=')",
          ...
          >
            ...
            <h1 className="text-4xl font-bold mb-4 text-shadow">Web Stories</h1>
            <p className="text-xl max-w-2xl text-shadow">
              Immerse yourself in captivating web stories that bring together stunning visuals and compelling narratives, perfect for your digital journey.
            </p>
