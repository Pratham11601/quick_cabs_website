...
const Testimonials = () => {
  ...
  return (
    <section className="bg-white py-16 px-8 relative">
      <div className="max-w-5xl mx-auto relative">
        ...
        {/* Testimonial Cards */}
        <div className="relative flex overflow-hidden h-[350px]">
          {testimonials.map((testimonial, index) => (
            <div
              key={testimonial.id}
              className={`absolute inset-0 w-full h-full flex flex-col md:flex-row items-center justify-center p-8 transition-transform duration-500 ease-in-out ${
            ...
            >
              <div className="md:w-1/2 mb-8 md:mb-0 text-center md:text-left">
                <h2 className="text-2xl sm:text-4xl font-extrabold mb-4 text-gray-900">
                  {testimonial.headline}
                </h2>
                <p className="text-lg sm:text-xl text-gray-700 mb-4">{testimonial.text}</p>
              ...
              <img
                ...
                className="rounded-lg shadow-md w-48 h-48 sm:w-72 sm:h-72 object-contain"
                />
              </div>
            </div>
          ))}
