      ...
      <div className="max-w-5xl mx-auto shadow-lg bg-white rounded-lg">
        ...
        <div className="px-8 py-12">
          <section className="mb-10">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              Welcome to our website. If you continue to browse and use this website, you are agreeing to comply with and be bound by the following terms and conditions of use, which together with our privacy policy govern Quick Cab Services' relationship with you in relation to this website. If you disagree with any part of these terms and conditions, please do not use our website.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-base text-gray-700 leading-relaxed">
              The term 'Quick Cab Services' or 'us' or 'we' refers to Quick Cab Services whose registered office is Shop No. 14, Chaurang Sanskriti, Bhosale Nagar, Hadapsar, Pune-28, Maharashtra. The term 'you' refers to the user or viewer of our website.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <ul className="list-disc list-inside text-base text-gray-700 leading-relaxed">
              ...
              <li>Specific offers may have additional Terms & Conditions which the user has to comply with in case they choose to avail of that offer.</li>
            </ul>
          </section>

          <section className="mb-10">
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Cancellation and Returns</h2>
            <p className="text-base text-gray-700 leading-relaxed">
              You may cancel the booking up to 1 hour before the journey without any cancellation charges for all services. However, last-minute cancellations might cause a loss to the driver. Therefore, we recommend canceling as soon as you have learned of the change in your travel plans. You can cancel your booking online or through the Quick Cab Services app.
            </p>
          </section>
